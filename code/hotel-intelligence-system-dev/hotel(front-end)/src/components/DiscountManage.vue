...
<!--        </el-table-column>-->
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div class="cell" v-if="scope.row.effectType == '2'"><el-tag>离开酒店</el-tag></div>
          <div class="cell" v-if="scope.row.effectType == '0' || scope.row.effectType == '1'"><el-tag type="success">进入酒店</el-tag></div>
        </template>
      </el-table-column>
<!--      <el-table-column-->
<!--          align="center"-->
...
<!--          <div>-->
<!--&lt;!&ndash;            <el-radio v-model="form.type" label="0">酒店折扣</el-radio>&ndash;&gt;-->
<!--            <el-radio v-model="form.type" :label="1">酒店内个人折扣</el-radio>-->
<!--&lt;!&ndash;            <el-radio v-model="form.type" label="2">折扣</el-radio>&ndash;&gt;-->
<!--          </div>-->
<!--        </div>-->
<!--        <div class="d-flex align-items-center mb-15">-->
<!--          <p class="w-100 text-left">类型:</p>-->
<!--          <div>-->
<!--            <el-radio v-model="form.discountsType" :label="0">进入酒店</el-radio>-->
<!--            <el-radio v-model="form.discountsType" :label="1">离开酒店</el-radio>-->
<!--          </div>-->
<!--        </div>-->
<!--        <div class="d-flex align-items-center mb-15">-->
<!--          <p class="w-100 text-left">时间:</p>-->
...
<!--        </div>-->
        <div class="d-flex align-items-center mb-15">
          <p class="w-100 text-left">类型:</p>
          <div>
            <el-radio v-model="form.effectType" :label="0">进入酒店</el-radio>
<!--            <el-radio v-model="form.effectType" :label="1">满?钱立减</el-radio>-->
            <el-radio v-model="form.effectType" :label="2">离开酒店</el-radio>
          </div>
        </div>
