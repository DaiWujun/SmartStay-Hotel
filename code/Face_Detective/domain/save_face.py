        ...
        if ord('s') == key:
            ...
            if len(faces):
                ...
                if 1 == len(faces):
                    ...
                    save_image(frame, '../faces_saved/test', 'test' + str(num) + '.jpg')
                    ...
                    if num == 1:
                        ...
                        with open('../faces_saved/test/face_data.json', 'r') as face_data_dic_file:
                            face_data_dic = json.load(face_data_dic_file)
                    with open('../faces_saved/test/face_data.json', 'w') as face_data_dic_file:
